export const seoAuditSmokePrompt = [
  ...
  "Compare against prior memory when available. Use local history under reports/seo-audit/history by default, and write artifacts under reports/seo-audit when filesystem access exists.",
