// Shared prompt text for this project's X growth agent. Keep schedules and workflows thin by
// importing these constants instead of inlining copies. The agent's behavior now lives in
