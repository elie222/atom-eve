...
For Product QA (slug `website-qa`) specifically, the agent's job is to test real product flows in the browser. Do not substitute an HTML, SEO, or landing-page audit when browser automation is blocked. Report the blocker clearly.
